defmodule MinhaCasaAiWeb.Router do
  ...
  scope "/api", MinhaCasaAiWeb do
    ...
    get "/admin/organizations", AdminController, :organizations
    patch "/admin/organizations/:id/license-limit", AdminController, :update_license_limit
  ...
  scope "/api", MinhaCasaAiWeb do
    ...
    get "/workspace/listing-features", WorkspaceController, :listing_features_index
    put "/workspace/listing-features", WorkspaceController, :listing_features_update
