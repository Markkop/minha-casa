defmodule MinhaCasaAiWeb.BillingJSON do
  ...
  def plan(plan) do
    %{
      ...
      includedSeats: Map.get(plan, :included_seats),
      additionalSeatPriceInCents: Map.get(plan, :additional_seat_price_in_cents),
  ...
  def subscription(sub) do
    %{
      ...
      licensedSeats: Map.get(sub, :licensed_seats),
      pendingLicensedSeats: Map.get(sub, :pending_licensed_seats),
      pendingSeatsEffectiveAt: datetime_to_iso(Map.get(sub, :pending_seats_effective_at)),
