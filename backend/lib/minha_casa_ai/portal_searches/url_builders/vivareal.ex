defmodule MinhaCasaAi.PortalSearches.UrlBuilders.VivaReal do
  @moduledoc false
  ...
  def build(filter_set, opts \\ []) do
    ...
    tipo = Shared.vivareal_tipo_slug(Shared.primary_tipo(filter_set))
    ...
    %{urls: urls, notes: ["Viva Real: shares Grupo OLX query params with Zap."]}
  end
