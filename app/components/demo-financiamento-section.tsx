          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              ...
              <div className="space-y-1">
                <Label className="text-xs text-app-muted">Valor do Imóvel alvo</Label>
                <Slider
                  value={[valorImovel]}
              ...
              <div className="space-y-1">
                <Label className="text-xs text-app-muted">Taxa de Juros Anual</Label>
                <Slider
                  value={[taxaAnual * 100]}
              ...
              <div className="space-y-1">
                <Label className="text-xs text-app-muted">Imóvel Existente</Label>
                <Slider
              ...
              {/* Column 2: TR Mensal */}
              <div className="space-y-1">
                <Label className="text-xs text-app-muted">TR Mensal</Label>
                <Slider
                  value={[trMensal * 100]}
              ...
              <div className="space-y-1">
                <Label className="text-xs text-app-muted">Capital Disponível (Entrada)</Label>
                <Slider
              ...
              <div className="space-y-1">
                <Label className="text-xs text-app-muted">Aporte Extra Mensal</Label>
                <Slider
                  value={[aporteExtra]}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label className="text-xs text-app-muted">Simular com Valores Variados (Imóvel Alvo)</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-xs text-app-muted">Simular com Valores Variados (Imóvel Existente)</Label>
                  <div className="flex gap-2 flex-wrap">
                    {PERCENTAGE_OPTIONS.map(({ value, label }) => (
                      <button
                        key={`apto-${value}`}
              ...
              {/* Estratégias */}
              <div className="space-y-2">
                <Label className="text-xs text-app-muted">Estratégias</Label>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-app-border bg-app-bg">
                  ...
                  <th className="px-3 py-2 text-left text-xs font-medium text-app-muted">Estratégia</th>
                ...
                {sortedCenarios.slice(0, 12).map((c) => (
                  ...
                  >
                    <td className="w-8 px-2 py-2 text-center">
                      {c.isBest && <span className="text-app-accent">✓</span>}
                    </td>
                    <td className="px-3 py-2 font-mono text-app-fg whitespace-nowrap">
                      {formatCurrencyCompact(c.valorImovel)}
                    </td>
                    <td className="px-3 py-2 font-mono text-rose-700 whitespace-nowrap">
                      {formatCurrencyCompact(
                    ...
                    <td className="px-3 py-2 text-right font-mono text-sm font-bold text-app-fg whitespace-nowrap">
                      {formatCurrencyK(c.aporteExtra + c.tabelaPadrao.primeiraParcelar)}
                    </td>
                    <td className="px-3 py-2 text-right font-mono text-sm text-app-fg">
                    ...
                    <td className="px-3 py-2 text-right font-mono text-sm font-bold text-rose-700 whitespace-nowrap">
