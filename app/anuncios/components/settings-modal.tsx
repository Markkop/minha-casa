    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center">
      ...
      <Card className="relative z-10 w-full max-w-md mx-4 bg-app-surface border-app-border">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <ModalHeaderTitle icon={Settings} title="Configurações" />
          <ModalCloseButton onClick={onClose} />
        </CardHeader>
        <CardContent className="space-y-6">
          {/* AI Status */}
          <div className="space-y-2">
            <p className="text-sm text-app-muted">Status da IA</p>
          ...
          {/* Info */}
          <div className="text-xs text-muted-foreground space-y-1 border-t border-app-border pt-4">
            <p className="font-medium text-app-muted">Sobre o Parser de IA:</p>
