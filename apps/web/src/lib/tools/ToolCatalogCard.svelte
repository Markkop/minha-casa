<script lang="ts">
  ...
  import ToolCatalogPreview from "$lib/tools/previews/ToolCatalogPreview.svelte";
  import type { ToolCatalogEntry } from "$lib/tools/tools-catalog";
