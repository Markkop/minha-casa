<script lang="ts">
  import DualMetricStack from "$lib/components/listings/DualMetricStack.svelte";
  import { formatM2Value } from "$lib/components/listings/listings-metric-stacks-shared";
