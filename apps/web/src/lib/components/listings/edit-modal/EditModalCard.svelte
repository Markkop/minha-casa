<script lang="ts">
  ...
  import { EDIT_MODAL_TABS, type EditModalTabId } from "$lib/components/listings/edit-modal/edit-modal-tabs";
  import EditModalTabBasic from "$lib/components/listings/edit-modal/EditModalTabBasic.svelte";
