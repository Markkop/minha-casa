<script lang="ts">
  ...
  import MergeReviewFields from "$lib/components/anuncios/MergeReviewFields.svelte";
  import MergeReviewImageGallery from "$lib/components/anuncios/MergeReviewImageGallery.svelte";
