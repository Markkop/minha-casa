<script lang="ts">
  ...
  import AmbienteCard from "$lib/components/analise/AmbienteCard.svelte";
  import UnassignedPhotosCard from "$lib/components/analise/UnassignedPhotosCard.svelte";
