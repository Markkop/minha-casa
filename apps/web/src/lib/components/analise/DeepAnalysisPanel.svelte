<script lang="ts">
  ...
  import AnalysisSections from "$lib/components/analise/AnalysisSections.svelte";
  ...
  <WorkspacePanel class="p-4">
    <div class="flex flex-wrap items-start justify-between gap-4">
      ...
      <div class="flex flex-wrap items-center gap-2">
        <Button type="button" onclick={handleRun} disabled={analysisState.isStarting || analysisState.isRunning}>
