<script lang="ts">
  ...
  import { getListingDecisionNotesContext } from "$lib/components/analise/listing-decision-notes.svelte";

  const { draft, setDraft, save, isSaving } = getListingDecisionNotesContext();
</script>
