<script lang="ts">
  ...
  import NearbyPlacesContent from "$lib/components/analise/NearbyPlacesContent.svelte";
  import NearbyPlacesTabs from "$lib/components/analise/NearbyPlacesTabs.svelte";
