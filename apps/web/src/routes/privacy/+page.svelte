<main class="mx-auto max-w-3xl space-y-8 px-6 py-12">
  ...
  <section class="space-y-3">
    <h2 class="text-xl font-semibold">Como usamos os dados</h2>
    <ul class="list-disc space-y-2 pl-6 text-muted-foreground">
  ...
  <section class="space-y-3">
    <h2 class="text-xl font-semibold">Serviços terceiros</h2>
    <p class="text-muted-foreground">
  ...
  <section class="space-y-3">
    ...
    <p class="text-muted-foreground">
      ...
      ou escreva para <a class="text-app-accent hover:underline" href="mailto:me@markkop.dev">me@markkop.dev</a>.
    </p>
  </section>

  <p class="text-sm text-muted-foreground">
    Veja também nossos <a class="text-app-accent hover:underline" href="/terms">Termos de Uso</a>.
  </p>
</main>
