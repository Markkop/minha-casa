<main class="mx-auto max-w-3xl space-y-8 px-6 py-12">
  ...
  <section class="space-y-3">
    <h2 class="text-xl font-semibold">Conta e responsabilidade</h2>
  ...
  <section class="space-y-3">
    <h2 class="text-xl font-semibold">Uso aceitável</h2>
  ...
  <section class="space-y-3">
    <h2 class="text-xl font-semibold">Pagamentos e assinaturas</h2>
    <p class="text-muted-foreground">
  ...
  <section class="space-y-3">
    <h2 class="text-xl font-semibold">Disponibilidade e alterações</h2>
    <p class="text-muted-foreground">
  ...
  <section class="space-y-3">
    <h2 class="text-xl font-semibold">Privacidade e encerramento</h2>
    <p class="text-muted-foreground">
      O tratamento de dados está descrito na <a class="text-app-accent hover:underline" href="/privacy">Política de Privacidade</a>.
      Para solicitar exclusão de conta ou dados, consulte
      <a class="text-app-accent hover:underline" href="/data-deletion">Exclusão de dados</a>
      ou envie um email para <a class="text-app-accent hover:underline" href="mailto:me@markkop.dev">me@markkop.dev</a>.
    </p>
  </section>
</main>
